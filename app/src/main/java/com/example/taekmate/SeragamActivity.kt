...
class SeragamActivity : AppCompatActivity() {

    private lateinit var rvSeragam: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvSeragam = findViewById(R.id.rvSeragam)
        rvSeragam.layoutManager = GridLayoutManager(this, 2)

        val dbHelper = DBHelper(this)
        val seragamItems = dbHelper.getItemsByCategory("Seragam")

        rvSeragam.adapter = DashboardAdapter(seragamItems) { item, action ->
