...
class AlatLatihanActivity : AppCompatActivity() {

    private lateinit var rvAlatLatihan: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_alatlatihan)
        ...
        rvAlatLatihan = findViewById(R.id.rvAlatLatihan)
        rvAlatLatihan.layoutManager = GridLayoutManager(this, 2)

        val dbHelper = DBHelper(this)
        val alatlatihanItems = dbHelper.getItemsByCategory("Alat Latihan")

        rvAlatLatihan.adapter = DashboardAdapter(alatlatihanItems) { item, action ->
